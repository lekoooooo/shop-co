...
// //     ? getNumericPrice(product.originalPrice)
// //     : null;
// //   const currentOriginalPrice = baseOriginalPrice
// //     ? (baseOriginalPrice * quantity).toFixed(2)
// //     : null;
...
//   const sizes = ["Small", "Medium", "Large", "X-Large"];
//   const colors = [
//     { name: "brown", image: "/images/browncircle.svg" },
//     { name: "green", image: "/images/green.svg" },
//     { name: "purple", image: "/images/purple.svg" },
//   ];
...
//         <div className="flex items-center mb-6 text-gray-600 text-sm">
//           <p className="hover:text-gray-900">Home</p>
//           <img src="/images/smallarrow.svg" alt=">" className="mx-2 w-2 h-2" />
//           <p className="hover:text-gray-900">Shop</p>
//           <img src="/images/smallarrow.svg" alt=">" className="mx-2 w-2 h-2" />
//           <p className="hover:text-gray-900">Men</p>
//           <img src="/images/smallarrow.svg" alt=">" className="mx-2 w-2 h-2" />
...
//             <div className="flex items-center gap-1 mb-4">
//               <img
//                 src={`/images/star-${product.rating}.svg`}
//                 alt="Rating"
//                 className="h-4"
//               />
//               <span className="text-sm">{product.rating}/5</span>
        ...
        <div className="flex md:flex-row flex-col gap-8">
          ...
          <div className="md:w-1/2">
            ...
            <div className="space-y-2 mb-6 text-gray-600">
              <p>This graphic t-shirt which is perfect for any occasion.</p>
              <p>
                Crafted from a soft and breathable fabric, it offers superior
                comfort and style.
              </p>
          ...
          <div className="py-6">
            {activeTab === "details" && (
              <div className="space-y-2">
                <h4 className="mb-4 font-bold">Product Information</h4>
                <p className="text-gray-600">Material: 100% Cotton</p>
                <p className="text-gray-600">
                  Care: Machine wash cold, tumble dry low
                </p>
                <p className="text-gray-600">Fit: Regular fit</p>
                <p className="text-gray-600">Design: Graphic print on front</p>
              </div>
            )}
