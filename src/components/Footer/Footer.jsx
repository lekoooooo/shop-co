  ...
  return (
    <footer className="bg-[#F0F0F0] mx-auto mt-[100px] px-6 lg:px-20 py-[60px] lg:py-20 max-w-[392px] lg:max-w-full font-medium text-[#000000cc] text-sm">
      <div className="lg:mt-[50px] mb-6 lg:max-w-full lg:text-center">
        <h2 className="mb-2 font-[fontspring] font-extrabold text-[24px] text-black lg:text-[33px] lg:text-start">
          SHOP.CO
        </h2>
        <p className="lg:max-w-[250px] font-[satoshi] lg:text-[#00000099] lg:text-[14px] lg:text-start">
      ...
      <div className="hidden lg:block mb-[40px] font-[satoshi]">
      ...
      <div className="">
        <p className="font-[satoshi] text-[#00000099] text-[14px] text-center">
